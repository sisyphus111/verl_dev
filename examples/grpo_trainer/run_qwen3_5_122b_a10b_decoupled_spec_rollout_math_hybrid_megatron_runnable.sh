#!/usr/bin/env bash
# Qwen3.5-122B-A10B + Qwen3.5-0.8B decoupled speculative rollout GRPO
# with Megatron training. Target shape: 8 trainer nodes plus 1 free draft node,
# 72 GPUs total, with 8 GPUs reserved for drafter rollout.
...
project_name=verl_grpo_qwen3_5_122b_decoupled_spec
exp_name=qwen3_5_122b_a10b_72gpu_dspec
DSPEC_OUTPUT_DIR=${DSPEC_OUTPUT_DIR:-/mnt/hdfs/ord/qwen35-122b-a10b-filter-overlong-bs32-parallel-spec-rollout/resp}
CKPTS_DIR=${CKPTS_DIR:-/mnt/hdfs/ord/qwen35-122b-a10b-parallel-spec-rollout/ckpts}
save_contents="['model']"
...
ROLLOUT=(
    ...
    actor_rollout_ref.rollout.trace.trace_dir="${DSPEC_OUTPUT_DIR}"
