...
def _megatron_gptmodel_postprocess(
    ...
    if self.config.mtp_num_layers and labels is not None:
        if _HAS_PROCESS_MTP_LOSS:
            # Newer Megatron APIs handle chunking, rolling, and scaling inside process_mtp_loss.
            ...
            # Legacy Megatron API: manual rolling plus detached output-layer functional call.
